...
>
	<div class="flex h-full flex-col sm:flex-row">
		<!-- Sidebar (Desktop) -->
		<aside class="hidden w-64 flex-shrink-0 flex-col border-r border-gray-700 bg-app-bg sm:flex">
		...
		<!-- Mobile Header & Nav -->
		<div class="flex flex-col border-b border-gray-700 bg-app-bg sm:hidden">
