...
import { GoogleGenAI, HarmCategory, HarmBlockThreshold, type Tool, type Content, Type } from '@google/genai';
...
export async function callGeminiApiOnClient(
	...
	const genAI = new GoogleGenAI({ apiKey }); // オブジェクトとして渡す    // geminiModelConfigの定義を直接ここで行う
