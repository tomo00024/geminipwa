...
<style>
	...
	.chat-bubble {
		...
		/* ▼▼▼ ここが唯一の変更点です ▼▼▼ */
		display: inline-grid; /* grid から inline-grid へ変更 */
		/* ▲▲▲ ここが唯一の変更点です ▲▲▲ */
	...
	.editing-ui { display: flex; flex-direction: column; }
	...
	.textarea { background-color: transparent; color: black; padding: 0; border: none; outline: none; box-shadow: none; overflow: hidden; }
	.chat-bubble-primary .textarea { color: white; }
</style>